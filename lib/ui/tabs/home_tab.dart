      ...
      children: [
        Row(
          ...
          children: [
            ...
            CustomElevatedButton(onPressed: () => LanguageUtils.toggleLanguage(context),
            borderRadius: 8,verticalPadding: height * 0.01,horizontalPadding: width * 0.03,minimumSize: Size.zero,
            child: Text(context.locale.languageCode.toUpperCase(),style: AppStyles.white14SemiBold,),
            )
