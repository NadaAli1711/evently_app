...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar> {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(items: [
      buildBottomNavigationBarItem(index: 0,selectedIcon:AppImages.selectedHome,unSelectedIcon:AppImages.unSelectedHome, label: 'home'.tr()),
      buildBottomNavigationBarItem(index: 1,selectedIcon:AppImages.selectedHeart,unSelectedIcon:AppImages.unSelectedHeart,label:  'favorite'.tr()),
      buildBottomNavigationBarItem(index: 2,selectedIcon:AppImages.selectedUser,unSelectedIcon: AppImages.unSelectedUser,label:  'profile'.tr())
